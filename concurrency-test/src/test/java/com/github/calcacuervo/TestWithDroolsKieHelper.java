...
/**
 * Tests using KieHelper with concurrent access.
 * 
 * @author calcacuervo
 *
 */
public class TestWithDroolsKieHelper {
	...
	public static class TestRunner implements Runnable {
		...
		public void run() {
			...
			error = expectedVal.equals(h.sessionVal) ? ""
					: "Expected and session values are different. Expected: " + this.expectedVal + " Got: " + h.sessionVal;
		}
	}
